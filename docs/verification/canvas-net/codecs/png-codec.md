...
Builds a minimal PNG declaring an IHDR width one greater than `Surface.MaxDimension` (16384), and
...
A unit test run passes when all thirty-two test methods above (including each `[Theory]` case,
