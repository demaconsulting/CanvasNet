...
CanvasNet model and fails the build on any syntax or reference error. The build-docs
...
`SysML2Tools_CanvasNetViewSvg`), before Pandoc compiles `docs/design/*.md`, which embed
...
**Requirement coverage**: `CanvasNet-OTS-SysML2Tools-Lint`.
...
**Requirement coverage**: `CanvasNet-OTS-SysML2Tools-Render`.

#### SysML2Tools_SoftwareStructureViewSvg

**Scenario**: The build-docs CI job runs `dotnet sysml2tools render` against the real CanvasNet
...
#### SysML2Tools_CanvasNetViewSvg

**Scenario**: The build-docs CI job runs `dotnet sysml2tools render` against the real CanvasNet
model, then FileAssert checks the resulting file at
`docs/design/generated/CanvasNetView.svg`.
...
- **`CanvasNet-OTS-SysML2Tools-Lint`**: SysML2Tools_LintSelfTest
- **`CanvasNet-OTS-SysML2Tools-Render`**: SysML2Tools_RenderSvgSelfTest,
  SysML2Tools_SoftwareStructureViewSvg, SysML2Tools_CanvasNetViewSvg
