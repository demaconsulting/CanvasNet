...
**Requirement coverage**: `CanvasNet-OTS-VersionMark`.
...
**Requirement coverage**: `CanvasNet-OTS-VersionMark-Lint`.
...
- **`CanvasNet-OTS-VersionMark`**: VersionMark_CapturesVersions, VersionMark_GeneratesMarkdownReport
- **`CanvasNet-OTS-VersionMark-Lint`**: VersionMark_LintPassesForValidConfig,
  VersionMark_LintReportsErrorsForInvalidConfig
