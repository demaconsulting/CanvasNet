# Contributing to CanvasNet

Thank you for your interest in contributing to CanvasNet! We welcome contributions from the community and
...
- **Environment**: Operating system, .NET version, CanvasNet version
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/demaconsulting/CanvasNet.git
   cd CanvasNet
   ```
...
CanvasNet uses [DemaConsulting.ReqStream][reqstream] for requirements traceability:
...
By contributing to CanvasNet, you agree that your contributions will be licensed under the MIT License.

Thank you for contributing to CanvasNet!

[code-of-conduct]: https://github.com/demaconsulting/CanvasNet/blob/main/CODE_OF_CONDUCT.md
...
[discussions]: https://github.com/demaconsulting/CanvasNet/discussions
[issues]: https://github.com/demaconsulting/CanvasNet/issues
[security]: https://github.com/demaconsulting/CanvasNet/blob/main/SECURITY.md
